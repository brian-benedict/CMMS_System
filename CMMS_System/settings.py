"""
Django settings for CMMS_System project.
...
SECRET_KEY = 'django-insecure-#6@n8&l11r$-xhv*h=_b+3l9p+6jx#b3@vb_@30)*wut6i(n7h'
...
WSGI_APPLICATION = 'CMMS_System.wsgi.application'
